...
SCORE_2024_CSV_PATH = os.path.join(BASE_DIR, '../../public/diem_thi_thpt_2024_to_hop.csv')
...
PREDICTED_BENCHMARK_PATH = os.path.join(BASE_DIR, '../../public/predictions_2026.csv')
...
try:
    ...
    predicted_benchmark_df = pd.read_csv(PREDICTED_BENCHMARK_PATH)
    ...
    predicted_benchmark_df = pd.DataFrame()
