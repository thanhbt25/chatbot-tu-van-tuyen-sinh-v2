...
from actions.actions_predict_cutoff import ActionPredictCutoff
...
# Khởi tạo action
action_predict_cutoff = ActionPredictCutoff()
...
action_predict_cutoff.run(dispatcher1, tracker1, {})
...
action_predict_cutoff.run(dispatcher2, tracker2, {})
...
action_predict_cutoff.run(dispatcher3, tracker3, {})
...
action_predict_cutoff.run(dispatcher4, tracker4, {})
...
action_predict_cutoff.run(dispatcher5, tracker5, {})
...
action_predict_cutoff.run(dispatcher6, tracker6, {})
...
action_predict_cutoff.run(dispatcher7, tracker7, {})
...
action_predict_cutoff.run(dispatcher8, tracker8, {})
...
action_predict_cutoff.run(dispatcher9, tracker9, {})
...
action_predict_cutoff.run(dispatcher10, tracker10, {})
...
action_predict_cutoff.run(dispatcher11, tracker11, {})
...
action_predict_cutoff.run(dispatcher12, tracker12, {})
